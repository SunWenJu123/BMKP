...
class MNISTMLP(nn.Module):
    ...
    def __init__(self, input_size: int, output_size: int, hidden_dim=[100, 100]) -> None:
        """
        ...
        self.fc1 = nn.Linear(self.input_size, hidden_dim[0])
        ...
        self.classifier = nn.Linear(hidden_dim[1], self.output_size)
